...
with open('heartdisease/heartdisease.txt', 'r') as in_file:
    stripped = (line.strip() for line in in_file)
    lines = (line.split(",") for line in stripped if line)
    with open('heartdisease/heartdisease.csv', 'w',newline='') as out_file:
...
filename = 'heartdisease/heartdisease.csv'
